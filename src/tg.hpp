 ...
 * @LastEditTime: 2021-08-20 21:37:39
...
namespace dh
{
    namespace tg // tg means trajectory generator.
    {
        ...
        public:
            ...
            void add_motion(const double wx, const double wy, const double wz, const double ax, const double ay, const double az, const double lasting_time, const double start_time)
            {
                this->check();

                this->motion_vector.push_back(++this->motion_num); // col1
                this->motion_vector.push_back(start_time);         // col2
                this->motion_vector.push_back(lasting_time);       // col3
                this->motion_vector.push_back(wx);                 // col4
                this->motion_vector.push_back(wy);                 // col5
                this->motion_vector.push_back(wz);                 // col6
                ...
                double end_time = start_time + lasting_time;
                if (end_time > this->total_time)
