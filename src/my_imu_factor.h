...
#ifndef DH_MY_IMU_FACTOR_H
#define DH_MY_IMU_FACTOR_H
...
namespace dh{
  class MyIMUFactor : public ceres::SizedCostFunction<15, 7, 9, 7, 9>
{
  public:
    MyIMUFactor() = delete;
    MyIMUFactor(PreIntegrationTerm* _pre_integration):pre_integration(_pre_integration)
    {
    }
...
///                ROS_BREAK();
    ...
    PreIntegrationTerm* pre_integration;
